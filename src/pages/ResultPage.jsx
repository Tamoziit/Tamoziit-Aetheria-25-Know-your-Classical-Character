...
const ResultPage = ({ onClose, onPlayAgain, onViewLeaderboard }) => {
	...
	return (
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden parchment-bg">
			...
			>
				...
				<button
					onClick={onClose}
					className="absolute top-6 right-10 w-10 h-10 bg-bronze/20 hover:bg-bronze/30 rounded-full flex items-center justify-center text-bronze hover:text-bronze-dark transition-colors z-10 font-semibold"
				>
					✕
				</button>
				...
				<div className="relative p-4 text-center">
					...
					<motion.div
						...
						className="inline-flex items-center gap-2 bg-gradient-to-r from-gold to-gold-dark text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg mb-3"
					>
